...
import { CloudArrowUpIcon, MagnifyingGlassIcon, PencilIcon, XMarkIcon } from "@heroicons/react/24/outline";
import { Button, Card, CardBody, CardFooter, CardHeader, Dialog, DialogBody, Input, Option, Select, Textarea, Tooltip, Typography } from "@material-tailwind/react";
                ...
                {paginatedRows.length > 0 ? paginatedRows.map((record, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className={classes}>
                        <Button color="blue" size="sm" variant="outlined" className="mr-2" onClick={() => { setModalData({ ...record }); toggleModal(2) }}>
                          Edit
                        </Button>
