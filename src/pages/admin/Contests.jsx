...
const schema = yup.object({
  ...
  image: yup.string().trim().required('Enter target vote form the position'),
  status: yup.string().trim().required('Enter target vote form the position'),
  date: yup.string().trim().required('Enter target vote form the position'),
})
