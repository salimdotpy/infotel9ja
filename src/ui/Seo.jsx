...
const Seo = ({ data = {}, url = window.location.href }) => {
    return (
        <Helmet>
            {/* Basic Meta */}
            <title>{data?.siteTitle || "12InfoTel9ja Global Network Presents: Osun State Contest"}</title>
            ...
            <meta property="og:title" content={data?.socialTitle || "12Celebrate Osun's Finest: Influencers & Football Fans Unite!"} />
            ...
            <meta property="og:image" content={data?.seo || "https://infotel9ja.vercel.app/images/img1.jpeg"} />
            <meta property="og:image:width" content="800" />
            <meta property="og:image:height" content="600" />
            <meta property="og:image:alt" content="logo" />
            <meta property="og:url" content={url} />
            <meta property="og:keywords" content={data?.metaKeyword || "12Osun State contest, influential personalities, football diehard fans, community engagement, social interaction, Osun State events, football fan contest, influencer recognition"} />

            {/* Twitter Cards */}
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:title" content={data?.socialTitle || "12Celebrate Osun's Finest: Influencers & Football Fans Unite!"} />
            ...
            <link rel="icon" type="image/svg+xml" href={data?.favicon || "https://infotel9ja.vercel.app/images/logoIcon/favicon.png"} />
        </Helmet>
    );
};
